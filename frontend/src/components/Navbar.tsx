    ...
    <>
      ...
      >
        <div className="flex justify-center items-center gap-1">
          <Link to="/">
            <img src="/assets/logo3.png" alt="logo" className="h-8.5 w-auto" />
          </Link>
          <h2 className="text-[24px] font-semibold">ThumbClick</h2>
        </div>
        ...
        <div className="flex items-center gap-2">
          {isLoggedin ? (
            <div className="relative group">
              <button className="rounded-full size-8 bg-white/20 border-2 border-white/20">
